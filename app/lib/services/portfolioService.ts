...
export class PortfolioService {
    ...
    static async getById(supabase: SupabaseClient<Database>, id: string): Promise<PortfolioSection | null> {
        const { data, error } = await supabase
            .from('sections')
            .select(`
                *,
    ...
    static async upsertSection(supabase: SupabaseClient<Database>, section: Partial<PortfolioSection>): Promise<PortfolioSection> {
    ...
    static async upsertItem(supabase: SupabaseClient<Database>, item: SectionItem): Promise<SectionItem> {
