    ...
    <div>
      ...
      <div className="space-y-4">
        {posts.map((post) => (
          <div
            key={post.id}
            className="bg-neutral-900 p-4 rounded border border-white/10 flex justify-between items-center"
          >
            <div>
  ...
  return (
    <div className="bg-neutral-900 border border-white/10 p-6 rounded-lg max-w-2xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          <ImageUploader label="News Image" value={imageUrl} onChange={setImageUrl} />
        </div>
